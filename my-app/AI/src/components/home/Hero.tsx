  ...
  return (
    ...
    >
      ...
      <div className="container relative z-40 mt-16">
        <h1 className="text-5xl font-bold text-center"> Your AI CoPilot For Smart Automobile Navigation </h1>
        <p className="mt-4 text-lg text-gray-600 text-center">
          Real-time navigation, smart parking, eco-friendly routes, carpool matching, and EV charging stations — all in one intelligent platform.
        </p>
        <div className="flex mt-5 justify-center items-center">
          {/* Link wrapped around GradientButton */}
          <Link href="/sign-in">
        <GradientButton
          initial="close"
          whileInView="open"
